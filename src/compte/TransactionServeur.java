...
public class TransactionServeur extends TransactionPOA {
	...
	public String updateDetails(String counterId, String date, double amountDebit, double amountCredit,
			String accountId) {
		try {
			transactionId += 1;
			int id_ = transactionId;
			Class.forName("com.mysql.jdbc.Driver");
			Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/bankcorba", "root", "");
	...
	public static void main(String args[]) {
		...
		properties.put("org.omg.CORBA.ORBInitialHost", "192.168.1.13");
		...
		try {
			...
			org.omg.CORBA.Object ref = rootpoa.servant_to_reference(transaction);
			 System.out.println("this is  corba obj from server  :" + ref.toString());
